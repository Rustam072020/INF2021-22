...
import ru.itis.repository.FilesRepositoryJdbсImpl;
...
public class SettingsServiceImpl implements SettingsService {
    ...
    @Autowired
    public SettingsServiceImpl(FilesRepositoryJdbсImpl filesRepositoryJdbsImpl, UserRepositoryJdbсImpl userRepositoryJdbsImpl) {
        this.filesRepository = filesRepositoryJdbsImpl;
