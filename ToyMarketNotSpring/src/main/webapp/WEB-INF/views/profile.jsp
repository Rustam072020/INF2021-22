...
<div class="row">
    <div class="navbar fixed-top navbar-expand-lg bg-light container-fluid">
        ...
        <div class="col-2">
            ...
            <a class="navbar-brand" href="/in/settings">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" class="bi bi-gear" viewBox="0 0 16 16">
...
<div class="container bootdey">
    <div class="profile-page">
        <div class="page-header header-filter" data-parallax="active" style="transform: translate3d(0px, 0px, 0px); border-radius: 10px; background-color: #bdf8f8;"></div>
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-xs-offset-3">
                            <div class="profile">
                                ...
                                <div class="avatar">
                                    <img src="/img/<%=user.getAvatar()%>" style="border-radius: 100px" alt="Circle Image" class="img-responsive img-raised">
                                </div>
                                <div class="name">
